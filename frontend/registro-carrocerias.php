        ...
        <form id="formCarrocerias">
            <div class="row mb-3">
                <div class="col-md-4">
                    ...
                    <input type="text" id="matricula" name="matricula" class="form-input" placeholder="Ej. ABC-1234"
                        required maxlength="100" pattern="^[A-Z0-9\s\-]+$" 
            ...
            <div class="row mb-3">
                <div class="col-md-4">
                    ...
                    <input type="number" step="0.01" id="peso_vehicular" name="peso_vehicular" class="form-input"
                        placeholder="Ej. 1500.50" required min="1">
                </div>
                <div class="col-md-4">
                    <label for="numero_ejes" class="form-label">Número de Ejes</label>
                    <input type="number" id="numero_ejes" name="numero_ejes" class="form-input"
                        placeholder="Ej. 2" min="1" max="20">
                </div>
                <div class="col-md-4">
                    <label for="numero_contenedores" class="form-label">Número de Contenedores</label>
                    <input type="number" id="numero_contenedores" name="numero_contenedores" class="form-input"
                        placeholder="Ej. 1" min="0" max="10">
                </div>
            </div>
